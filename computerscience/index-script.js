  ...
  const programmingLanguages = {
    ...
    'java': ['java-intro.html', 'java-variables.html', 'java-conditions.html', 'java-arrays.html'],
    'ruby': ['ruby-intro.html', 'ruby-syntax.html', 'ruby-variables.html'],
    'swift': ['swift-intro.html', 'swift-variables.html', 'swift-conditions.html'],
    'kotlin': ['kotlin-intro.html', 'kotlin-variables.html', 'kotlin-conditions.html'],
    'go': ['go-intro.html', 'go-variables.html', 'go-conditions.html'],
    'php': ['php-intro.html', 'php-syntax.html', 'php-variables.html'],
    'typescript': ['ts-intro.html', 'ts-variables.html', 'ts-interfaces.html'],
    'r': ['r-intro.html', 'r-variables.html', 'r-vectors.html'],
    'sql': ['sql-intro.html', 'sql-select.html', 'sql-syntax.html', 'sql-joins.html'],
    'dart': ['dart-intro.html', 'dart-variables.html', 'dart-functions.html'],
    'matlab': ['matlab-intro.html', 'matlab-arrays.html', 'matlab-functions.html'],
    'bash': ['bash-intro.html', 'bash-functions.html', 'bash-variables.html'],
    'perl': ['perl-intro.html', 'perl-scalars.html', 'perl-control-structures.html'],
    'cpp': ['cpp-intro.html', 'cpp-variables.html', 'cpp-conditions.html', 'cpp-functions.html'],
    'json': ['json-intro.html', 'json-syntax.html'],
    'powershell': ['ps-intro.html', 'ps-cmdlets.html', 'ps-functions.html'],
    'shell': ['shell-intro.html', 'shell-functions.html', 'shell-syntax.html'],
    'assembly': ['asm-intro.html', 'asm-syntax.html', 'asm-instructions.html'],
    'yaml': ['yaml-intro.html', 'yaml-syntax.html'],
    'markdown': ['markdown-intro.html', 'markdown-syntax.html'],
    'bootstrap': ['bootstrap-intro.html', 'bootstrap-grids.html', 'bootstrap-components.html'],
    'tailwind': ['tailwind-intro.html', 'tailwind-fundamentals.html', 'tailwind-setup.html'],
    'tonejs': ['tone-intro.html', 'tone-synths.html', 'tone-effects.html'],
    'threejs': ['three-intro.html', 'three-basic-scene.html', 'three-meshes.html'],
